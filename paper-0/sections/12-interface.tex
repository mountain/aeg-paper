...
is a research stance, and the later papers depend on neither.  Similarly,
Section~\ref{sec:p0-holed} defines punctured spaces and registers six computed
witnesses, but attaches no AES data to the four-circle configuration and proves
no theorem about punctures beyond the definition and the tangent-cone
computation.  Both chapters should be read as research reports inside this
paper; where Papers~II--IV need a punctured or non-linear object, they should
import it from Paper~I or Paper~III, not from these two chapters, until the
problems of Subsection~\ref{subsec:p0-holed-open} are settled.
...
tearing and punctured spaces & research report; not yet an interface \\
\bottomrule
\end{tabular}
\end{center}
