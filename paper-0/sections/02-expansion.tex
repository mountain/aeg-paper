...
The two histories of Example~\ref{ex:p0-distributive-charge-transport} share
their motion and differ in their charge.  The difference is an instance of the
transport elements of Theorem~\ref{thm:p0-descent}: the chronological word of
$\gamma$ followed by the inverse of $\delta$ evaluates to the identity motion
while carrying additive charge $p(1-e^{q})$, which is the general phenomenon
that section names and measures.
