...
This identifies the path geometry of Section~\ref{sec:p0-aes} as a
...
$w_q=-1/(z-q)$ from \eqref{eq:p0-pole-coordinate}, whose sign is fixed by the
positivity convention of Section~\ref{sec:p0-ripples}, is the simplest such
gauge.
...
\subsection{Left and right representations in one projective line}
...
Section~\ref{sec:p0-expansion}.  The elementary table shows that every
