% Moved from Paper I appendix C (governance/00b, migration map); content unchanged.
...
\[
 ...
 a=-\frac xy.
\]
The elementary grid-map and Baumslag--Solitar calculations formerly included
here are now owned by Paper~0.
