% Moved from Paper I appendix B (governance/00b, migration map); content unchanged
% apart from cross-references.  The closing conventions are imported from Paper I
% appendix A.
...
its orientation choices are introduced in Section~\ref{sec:p0-acs-tearing}.
...
% Imported from Paper I appendix A on 2026-09-22 (governance/00b migration map):
% affine-group conventions now used by the cocycle sections above.
...
Maurer--Cartan forms used in Section~\ref{sec:p0-affine-cocycles} have the
following readings.
