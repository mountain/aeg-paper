...
\begin{proof}
    ...
    Now we rewrite the gradient equation~\eqref{eq:grad} as the following equation:
    $$\frac{da^2}{\mu^2 + a^2 \lambda^2} = ds^2$$
    hence, we have
    $$\frac{da^2}{\mu^2 + a^2 \lambda^2} = e^{2\rho}(du^2 + dv^2)$$
     \qedhere
\end{proof}
