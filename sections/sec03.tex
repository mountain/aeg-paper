...
\subsection{Local Descartes coordinate}\label{subsec:notion-study}
...
Now we introduce the formula of arithmetic torsion at infinitesimal level. Considering the commutator of two infinitesimal generating processes, we have
$$
...
\begin{equation}
  d\tau = - \mu \lambda dx dy\label{eq:arithmetic_torsion}
\end{equation}
