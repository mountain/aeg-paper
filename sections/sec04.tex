...
The question arises: What is the origin of the numbers $-1$, $-6$, and $-21$? By conceptualizing the area of the quadrilateral $ABCD$ as a basic unit cell, it becomes apparent that the number $1$ represents a single unit cell of $ABCD$. Similarly, the number $6$ corresponds to the area of $AEFG$, comprising six unit cells; and the number $21$ aligns with the area of $AHIJ$, encompassing twenty-one unit cells. This understanding allows us to appreciate how these values emerge naturally from the structure of the arithmetic space.
