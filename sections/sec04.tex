...
\subsection{A general settings and $\mathfrak{E}_1$ space}\label{subsec:generalsettings}
...
\subsection{Propgation in $\mathfrak{E}_1$ space}\label{subsec:propgation}
