...
In earlier drafts, the smooth, non-singular arithmetic expression space was denoted by $\mathfrak{E}_1$.

In the present work, we adopt a revised indexing: the non-singular case is denoted by $\mathfrak{E}_0$, while $\mathfrak{E}_1$ refers to the arithmetic expression space with a single isolated singularity.
