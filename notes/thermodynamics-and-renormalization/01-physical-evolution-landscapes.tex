...
\begin{thebibliography}{9}
    \bibitem{AEGNotesRGZH} Yuan, M. (Internal Communication/Notes). AEG Framework Notes. Current source: \texttt{03-aeg-flow-and-renormalization-zh.tex}; formerly \texttt{rg\_zh.tex}.
    \bibitem{AEGNotesRGZH02} Yuan, M. (Internal Communication/Notes). Analysis of Iterative Examples within the Arithmetic Expression Geometry (AEG) Framework. Current source: \texttt{04-renormalization-iteration-examples-zh.tex}; formerly \texttt{rg\_zh\_02.tex}.
