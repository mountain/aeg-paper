...
\subsection{The detailed construction of the grids}\label{sec:construction-of-grids}
...
\begin{itemize}
\item horizantal blue lines (additional lines) satisfying $y = 2^k, k \in \mathbb{Z}$
\item vertical green lines (multiplicative lines) satisfying
    \begin{itemize}
...
\caption{$\omega$ gives the assignment of the start points of green lines}\label{fig:griddetail}
\end{figure}
