...
We denote the grid described above as $G_0$. It is generated by the additional generator $1$ and the multiplicative generator $2$.
Later, we will classify this example as belonging to the first kind and will prove that assignments of the first kind are independent of the generators.
This means that it is possible to use the same assignment for different generators and different grid settings.
