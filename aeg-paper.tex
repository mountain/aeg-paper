...
\subsection{The construction of the grids $G_0$}\label{sec:construction-of-grids}
...
\subsection{The construction of the grids $G_1$}\label{sec:construction-of-grids}
...
\subsection{The construction of the grids $G_2$}\label{sec:construction-of-grids}
...
\subsection{Construction problem of order-4 apeirogonal tiling}\label{sec:tiling}

\newpage

\section{New perspectives and methods}\label{sec:function}

\subsection{On integral}\label{sec:function}
