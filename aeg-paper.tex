...
\section{Flow equation and related notion study}\label{sec:flowequation}
...
\section{Geometry caluclation}\label{sec:geometrycaluclation}

\input{sections/sec15.tex}

\section{Grid caluclation}\label{sec:gridcaluclation}
