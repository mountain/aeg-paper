...
\section{The first concrete example}\label{sec:firstkind}

\input{sections/sec04.tex}
\newpage

\section{Loop space and 3D surgeries}\label{sec:loopspace}
...
\section{The third kind of arithmetic expression space $\mathfrak{E}_3$}\label{sec:thirddkind}
