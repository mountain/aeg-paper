...
The algebraic structure of $E(\mu, \lambda)$ will depend on the type of equality we adopt:
\begin{itemize}
...
\begin{definition}\label{definition:path}
...
\item $\theta = \frac{\pi}{2}$: $a_1 = a_0 e^{\lambda}$
