...
This is the complex-analytic specialization of the relative zero-divisor picture
in Theorem~\ref{thm:relative-zero-divisor-decomposition}.  Irreducible factors over
the coefficient field record arithmetic components; after passing to a complex
parameter manifold and removing the discriminant, the geometric sheets form the
covering used below.  Neither passage identifies sheets with raw expression words.
...
In particular, a solution should be compatible with the history-to-divisor
functor requested in Problem~\ref{prob:history-to-divisor-functor}.
\end{problem}
