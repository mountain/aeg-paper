...
The relative-divisor theorem then separates three meanings that the geometry alone
cannot distinguish: irreducibility over the coefficient field, geometric sheets
after scalar extension, and analytic monodromy away from the discriminant.  A
general functor from marked histories to those divisors remains open, so the Hecke
model is claimed only at the projective-operator quotient level.
...
to draw another tube.  It is to construct the history-to-divisor functor, derive a
stateful decoration from it, and prove that the decoration survives every quotient
required to become a knot invariant.
