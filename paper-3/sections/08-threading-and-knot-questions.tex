...
complex multiplication.  These classical results now inhabit one
carrier--thread--spectral construction, but the LL--Igusa test remains open:
it must still be computed whether two lifts with the same $Q_0$ give different
genus-two moduli, Frobenius, or period data.
