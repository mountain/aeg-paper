...
\keywords{arithmetic expressions, flow equation, arithmetic expression space, the first kind arithmetic expression space}
...
This study seeks to explore the potential of extending these well-established ideas to identify and characterize
non-trivial geometric spaces formed by arithmetic expressions.
...
\begin{figure}[ht]
    ...
    \caption{Illustration of an addition-multiplication grid generated by $+ 1$ and $\times 2$ on the upper half-plane $\mathcal{H}$.}\label{fig:gridex0}
\end{figure}
...
\subsection{Setting of $\mathfrak{E}_1$ space}\label{sec:setting}

\subsection{Grid in $\mathfrak{E}_1$ space}\label{sec:grid}

\subsection{Eigenfunction of Laplacian}\label{sec:eigenfunction}
