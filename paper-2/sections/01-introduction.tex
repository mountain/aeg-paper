...
Arithmetic Expression Geometry (AEG) now develops its geometry in Paper~0 ---
arithmetic expression spaces, affine flow, the regular expression surface, and
contact curvature \cite{Yuan2026AEGPaperZero} --- and its history and projective
layer in Paper~0 \cite{Yuan2026AEGFoundations}.  The present paper asks the next
question: once the geometric data have been fixed, what analysis do they actually
support?  We answer it
...
therefore intrinsic to the data imported from Paper~0.
...
\begin{tikzpicture}[
  ...
  \node[box] (paperi) {Paper 0 affine propagation\\and assignment derivative rules};
...
\caption{The two analytic objects carried forward from Paper 0.  The surface branch
...
interpretation on the Paper 0 model.
...
\item The identity $\Delta_ga=2\lambda^2a$ from Paper 0 is pointwise.  The assignment
