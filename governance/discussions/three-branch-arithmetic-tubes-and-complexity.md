...
**Authority:** Subordinate to `governance/00–08`; not itself authoritative
...
| D-12 | Do not stabilize a knot claim until conjugation, stabilization, choice independence, and comparison with known invariants are proved. | adopted by authoritative scope | Existing knot calculations remain experiments or provenance. | Paper III and `../../notes/knots-and-loops/` |
...
**Allowed files:** Create only `governance/calculations/three-branch-symbolic-audit.md`.  
**Forbidden files:** `../../aeg-paper.tex`, `../../sections`, Papers I–IV sources, `governance/00–08`.  
...
**Allowed files:** Create only `governance/calculations/negative-branch-cayley-base.md`.  
...
**Allowed files:** Create only `governance/calculations/negative-branch-iwasawa-process-test.md`.  
...
**Allowed files:** Create only `governance/calculations/section-residue-gauge-test.md`.  
...
**Allowed files:** Create only `governance/audits/tube-source-and-properness.md`; read historical notes.  
