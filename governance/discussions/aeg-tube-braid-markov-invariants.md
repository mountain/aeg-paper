...
**File:** <code>governance/discussions/aeg-tube-braid-markov-invariants.md</code>  
...
**Files or passages still using the old form:** 以 <code>governance/04-current-to-target-map.md</code> 和 Z6 为准审计历史 notes。
...
|---|---|---|---|---|
| <code>governance/00-authoritative-scope.md</code> | Paper III 拥有 Tube/knot | authoritative | 全系列 | 保持不改 |
| <code>governance/03-theorem-dependency-graph.md</code> | A1, A4, T7, Z2, Z3, Z5, T8, Z6, T15–T17 | authoritative | 全系列 | 本任务不改；候选节点另候审批 |
...
需要明确 AEG coefficient/assignment family 的 discriminant 定义、stratification 与 transversality。所需证据为可计算局部模型及与 Z3/Z5 的接口。目标 Paper III。对应 <code>governance/08-open-questions.md</code> OQ-037。
...
**Forbidden files:** Paper I 正文、<code>governance/00–08</code>。  
