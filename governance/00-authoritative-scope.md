...
**File:** `governance/00-authoritative-scope.md`
...
2. this document;
3. `AGENTS.md`;
4. other authoritative files under `governance/`;
...
* record the question in `governance/08-open-questions.md`.
...
`governance/discussions/arithmetic-automorphic-zero-networks.md` and the
