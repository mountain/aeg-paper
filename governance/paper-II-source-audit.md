...
- `bibliography/aeg-paper.bib` for references actually cited by Paper II;
- `governance/paper-II-source-audit.md`;
- `governance/decisions-paper-II.md`;
- `governance/paper-II-closure-report.md`;
...
- `governance/migration-log.md` and `governance/source-inventory.md`.

## 3. Files forbidden to change

- the mathematical source and generated PDF under `paper-1/`;
- legacy `sections/sec*.tex` sources;
- files under `archive/`, `notes/`, `notes/knots-and-loops/`, and `images/sources/`;
