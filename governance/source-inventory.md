...
| `AGENTS.md` | KEEP / AUTHORITATIVE | Repository-wide working instructions; former governance copy consolidated here |
| `paper-1/aeg-paper-1.tex` | REWRITE / CANONICAL | Sole active Paper I entry point |
| `bibliography/aeg-paper.bib` | KEEP / CLEAN | Shared bibliography; used entries audited |
...
| `archive/legacy-root-manuscript/` | 15 | historical `aeg-paper.tex`, provenance README, and legacy `sections/sec01.tex`--`sec12.tex` | ARCHIVAL | audited portions rederived in `paper-1/sections/`; analytic → II; tube → III; quotient → IV |
...
| `../archive/plans/` | 2 | historical principles and study plan | ARCHIVAL | active plans live in `governance/` |
...
| `.bib` / `.bbl` | 2 / 1 | shared bibliography under `bibliography/` plus arXiv snapshot |
