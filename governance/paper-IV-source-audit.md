...
2. `README.md`, `AGENTS.md`, and the authoritative restructuring
   files `00` through `08`;
3. the canonical Papers I--III;
4. Paper IV working discussions under `governance/discussions/`;
...
- `governance/00-authoritative-scope.md`: the requirement that state, metric,
  encoding, cost, and machine model be explicit before complexity claims.
- `governance/06-editorial-rules.md`: claim-first exposition and separation of
...
- `governance/discussions/three-branch-arithmetic-tubes-and-complexity.md`:
