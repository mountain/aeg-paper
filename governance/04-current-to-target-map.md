...
**File:** `governance/04-current-to-target-map.md`
...
* link to `governance/00-authoritative-scope.md`;
...
```text
governance/archive/generated-discussions/
```
...
* active restructuring plans → `governance/`;
...
| `bibliography/aeg-paper.bib`                  | KEEP/CLEAN     | Shared bibliography                        |
...
* run the build;
* create `governance/audit-report.md`;
