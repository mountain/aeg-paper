...
\begin{scope}
  ...
  \draw[blue,scale=1.0,samples=360,domain=-120:-60.0,variable=\t] plot ({16 * cos(\t) },{16 + 16 * sin(\t)});
  ...
  \draw[green,scale=1.0,samples=360,domain=150:180,variable=\t] plot ({16 + 16 * cos(\t) },{16 * sin(\t)});
  ...
  \draw[green,scale=1.0,samples=360,domain=0.0:30.0,variable=\t] plot ({-16 + 16 * cos(\t) },{16 * sin(\t)});
\end{scope}
